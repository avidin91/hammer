...
export class Editor extends Component {
  ...
  state= {
    id: this.props.currentUser ? this.props.currentUser.id : null,
    avatarUrl: this.props.currentUser ? this.props.currentUser.img : '',
    name: this.props.currentUser ? this.props.currentUser.name : '',
    email: this.props.currentUser ? this.props.currentUser.email : '',
    userName: '',
    dateOfBirth: this.props.currentUser ? moment(this.props.currentUser.personalInfo.birthday) : null,
    phoneNumber: this.props.currentUser ? this.props.currentUser.personalInfo.phoneNumber : '',
    website: '',
    address: '',
    city: '',
    postcode: '',
